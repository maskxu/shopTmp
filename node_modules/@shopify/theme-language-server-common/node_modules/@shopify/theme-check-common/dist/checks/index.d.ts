...
export declare const recommended: ({
    ...
    create(context: {
        ...
        HtmlDanglingMarkerOpen: import("../types").CheckNodeMethod<import("../types").SourceCodeType.LiquidHtml, import("../types").LiquidHtmlNodeTypes.HtmlDanglingMarkerOpen>;
        ...
        "HtmlDanglingMarkerOpen:exit": import("../types").CheckNodeMethod<import("../types").SourceCodeType.LiquidHtml, import("../types").LiquidHtmlNodeTypes.HtmlDanglingMarkerOpen>;

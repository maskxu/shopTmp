...
export declare function outputActiveConfig(configPath?: string, themeRoot?: string): Promise<void>;
export declare function outputActiveChecks(configPath?: string, root?: string): Promise<void>;

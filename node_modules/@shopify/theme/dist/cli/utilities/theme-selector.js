...
import { Filter, filterThemes } from './theme-selector/filter.js';
 ...
 */
export async function findOrSelectTheme(session, options) {
 ...
 */
export async function findThemes(session, filterProps) {
    const themes = await fetchStoreThemes(session);

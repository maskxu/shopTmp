...
export declare function createDisabledChecksModule(): {
    DisabledChecksVisitor: {
        ...
        create(context: {
            ...
            HtmlDanglingMarkerOpen: import("../types").CheckNodeMethod<import("../types").SourceCodeType.LiquidHtml, import("@shopify/liquid-html-parser").NodeTypes.HtmlDanglingMarkerOpen>;
            ...
            "HtmlDanglingMarkerOpen:exit": import("../types").CheckNodeMethod<import("../types").SourceCodeType.LiquidHtml, import("@shopify/liquid-html-parser").NodeTypes.HtmlDanglingMarkerOpen>;
